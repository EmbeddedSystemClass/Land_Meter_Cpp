...
// Maybe set run later
   ...
   PWM heartBeat("0","0"); 
   heartBeat.setFrequency(1);                // Set frequency in Hz  1 Hz for normal or 100Hz for leveling operations
   ...
   // outGPIO.streamClose();
    ...
    while(landRun ){
        ...
        // one second stuff - send data if flag set
        // one minute stuff - check heater, system voltages, levels
